...
//! # Status
//!
//! **v0.18.1, and the service around these types runs operations and generated channels.** Since X-12,
...
/// to call it.
pub use connector_pack::{
    ConfigStore, ConfigValue, Egress, Field, MemoryConfig, PreparedChannelPlan,
};
