...
// somewhere a commit could pick it up is one rule, and two copies of it is how the two stores come
// to answer it differently. Nothing about the logic changed.
