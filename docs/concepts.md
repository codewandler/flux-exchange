...
| **Datasource** | A tenant-bound readable surface available to an app or managed agent. V1 reads live systems through governed operations; indexing is a separate later binding. | Exchange | Live as a frozen installation resource; connector retrieval backends remain upstream work |
