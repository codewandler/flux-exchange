...
## Acceptance
- [x] Old grant documents deserialize with an empty inbound grant set.
- [x] Every granted and requested event must belong to the binding's closed declaration.
- [x] Cross-tenant channel identifiers and ungranted event subsets are refused.
...
- 2026-08-03: the complete main and tag gates passed and closed inbound grants shipped in v0.15.0.
